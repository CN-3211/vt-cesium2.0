 ...
 * @LastEditTime: 2022-03-29 18:28:13
 * @FilePath: /vt-cesium2.0/src/utils/vue-utils/digTerrain/index.ts
 */
...
class digTerrainPlan {
   ...
   * @param {Cesium.Cartesian3[]} points
   */
  _createBottomSurface(points: Cartesian3[]) {
    const material = new ImageMaterialProperty({
   ...
   * @param {Number} depth
   */
  _updateExcavateDepth(depth: number) {

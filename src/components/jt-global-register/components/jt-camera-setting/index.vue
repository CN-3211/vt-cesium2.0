...
export default defineComponent({
  ...
  setup() {
    ...
    const enableMinimumDistanceTitle = '最小镜头距离设置'
    ...
    const enableMaximumDistanceTitle = '最大镜头距离设置'
    ...
    const enableRotateTitle = '启动相机旋转'
    ...
    const enableTranslateTitle = '启动相机平移'
